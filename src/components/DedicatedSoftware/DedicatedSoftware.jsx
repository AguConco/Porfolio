    ...
    return (
        <>
            <section className="dedicated-software-section">
                <h1 className='dedicated-software-title'>Desarrollo de aplicaciones a medida</h1>
                ...
                <p>
                    Al realizar una aplicación a media, conversamos sobre cuales son tus necesidades o que problema querés solucionar.
                    Luego de hacer un análisis, te presento cómo lo podríamos hacer y cual sería la mejor manera.
                </p>
                <p>
                    Una vez que hemos definido los detalles del proyecto, llegado a un acuerdo con un plan establecido y las metas claras, comenzamos a crear tu aplicación.
                </p>
